  ...
  return (
    <section id="home" className="h-screen flex items-center relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 right-0 bg-primary bg-opacity-50 flex justify-between items-center px-6 py-1 border-b border-muted border-opacity-10">
        ...
        <div className="font-mono text-xs text-muted">~OJAS SHINDE</div>
      </div>
        ...
        >
          ...
          >
            ...
            <div className="nothing-headline font-mono tracking-wide">
              <DottedText text="OJAS SHINDE" />
            </div>
            <div className="mt-3 text-gradient">Data Analytics & Full Stack Developer</div>
          </motion.h1>
          ...
          >
            MCA graduate with expertise in data analytics, machine learning, and full-stack development.
            Passionate about building scalable solutions and extracting insights from complex data to drive business decisions.
          </motion.p>
          ...
          >
            <a href="https://github.com/ojas0720" target="_blank" rel="noopener noreferrer"
            ...
            <a href="http://www.linkedin.com/in/ojasshinde" target="_blank" rel="noopener noreferrer"
              className="flex items-center gap-2 text-sm text-muted hover:text-light transition-colors">
              <svg className="social-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
          ...
          >
            ...
            <a href="/Ojas Shinde Resume.pdf" target="_blank" rel="noopener noreferrer" className="nothing-btn">
              RESUME
